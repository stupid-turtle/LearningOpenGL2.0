...
int main()
{
    ...
    unsigned int marble = loadTexture("../../../Com Resource/marble.jpg");
    unsigned int metal = loadTexture("../../../Com Resource/metal.png");
    ...
    unsigned int cubeTexture = loadTexture("../../../Com Resource/marble.jpg");
    unsigned int floorTexture = loadTexture("../../../Com Resource/metal.png");
