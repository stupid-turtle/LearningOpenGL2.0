...
public:
    ...
    void setUniform1i(const char* uniformName, GLint v0)
    {
        GLint propertyLocation = glGetUniformLocation(ID, uniformName);
        glUniform1i(propertyLocation, v0);
    }

    void setUniform1f(const char* uniformName, GLfloat v0)
    {
        GLint propertyLocation = glGetUniformLocation(ID, uniformName);
        glUniform1f(propertyLocation, v0);
    }
};
