...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //cubeShader.setVec3("light.position", lightPos);     // 点光源
        //cubeShader.setVec3("light.direction", lightDirection);  // 平行光

        cubeShader.setVec3("light.position", camera.Position);    // 聚光
        cubeShader.setVec3("light.direction", camera.Front);      // 聚光
